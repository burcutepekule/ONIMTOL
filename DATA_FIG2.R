...
mIgA_in           = NA # mSIgA affinities. NA is the baseline scenario, 
...
plot1 = 1 # to plot the unseen data gray rectangle
############# PLOTTING
...
graphics.off()
png(file =paste0("./FIGURE_2.png"),    # The directory you want to save the file in
    width     = 12,
    height    = 10,
    units     = "in",
    res       = 600)
